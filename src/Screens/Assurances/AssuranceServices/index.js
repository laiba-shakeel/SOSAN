    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <View style={styles.screenMiddle}>
                <View style={{ flexDirection: 'row', justifyContent: 'flex-end', width: deviceWidth / 1 - 30, alignItems: 'center', paddingVertical: 10 }}>
                    <Text style={{ fontSize: 20, paddingEnd: 5, color: baseColors.primaryColor }}>Skip</Text>
                    <AntDesign name="doubleright" size={20} style={{ color: baseColors.primaryColor }} />
                </View>
                <View style={{ height: deviceHeight / 2, justifyContent: 'space-around', paddingTop: 90 }}>
                    <View style={{ borderWidth: 2, height: 250, marginVertical: 25, borderRadius: 20, justifyContent: 'center', alignItems: 'center', borderColor: baseColors.lightGreyColor, width: deviceWidth / 1 - 30, marginHorizontal: 10 }}>
                        <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', }}>
                            <View><Text style={{ fontSize: 18, marginBottom: 5, fontWeight: 'bold', color: baseColors.lightGreyColor, textAlign: 'center' }}>You have no plan added</Text><View />
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', width: deviceWidth / 1 - 99, textAlign: "center" }}>
                                    ...
                                    <Text
                                        ...
                                        style={{ fontSize: 16, color: 'gray' }}>Add Your Insurence Details</Text><View />
                                </View>
                            </View>
                        </View>
                    </View>
